const projectData = [
    {
      id: 1,
      image_url: "https://github.com/DazedChou/Astronomy-Dashboard/blob/main/FullWebsite.gif",
      title: "AstroDash",
    ...
    {
      id: 2,
      image_url: "https://github.com/magickw/CodeQuiz/blob/main/assets/demo.gif",
      title: "CodeQuiz",
    ...
    {
      id: 3,
        image_url: "https://github.com/magickw/WeatherDashboard/blob/main/WeatherDashboard.gif",
      ...
      {
        id: 4,
        image_url: "src/assets/scheduler.gif",
      ...
      {
        id: 5,
        image_url: "src/assets/notetaker.gif",
        title: "Note Taker",
      ...
      {
        id: 6,
        image_url: "src/assets/techblog.gif",
        title: "Tech Blog",
